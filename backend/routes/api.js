...
router.get('/sheets/containers', async (req, res) => {
    ...
    try {
        ...
        const indices = {
            ...
            estimatedDeparture: headers.indexOf('Planned ETD'),
            fastestShipping: headers.indexOf('Updated ETD'),
            estimatedArrival: headers.indexOf('Planned ETA'),
            extendedDelivery: headers.indexOf('Updated ETA'),
